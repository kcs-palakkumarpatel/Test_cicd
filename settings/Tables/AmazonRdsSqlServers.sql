CREATE TABLE [settings].[AmazonRdsSqlServers] (
    ...
    [AwsRegion]                NVARCHAR (255)   COLLATE Latin1_General_CS_AS_KS_WS NULL,
    [AwsAccessKey]             NVARCHAR (255)   COLLATE Latin1_General_CS_AS_KS_WS NULL,
    [AwsSecretKey]             NVARCHAR (255)   COLLATE Latin1_General_CS_AS_KS_WS NULL,
    [AwsResourceId]            NVARCHAR (255)   COLLATE Latin1_General_CS_AS_KS_WS NULL,
    [RequestedLicenceLevel]    INT              NOT NULL,
    [EffectiveLicenceLevel]    INT              NOT NULL,
    CONSTRAINT [AmazonRdsSqlServers_Id] PRIMARY KEY CLUSTERED ([Id] ASC),
    CONSTRAINT [AmazonRdsSqlServers_Name] UNIQUE NONCLUSTERED ([Name] ASC)
);
