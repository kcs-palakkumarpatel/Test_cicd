CREATE FUNCTION [data].[AzureManagedInstance_Agent_Job_Schedule_StableSamples_Removable]
(
...
INNER JOIN [data].[AzureManagedInstance_Agent_Job_Schedule_StableSamples] ON [data].[AzureManagedInstance_Agent_Job_Schedule_StableSamples].[Id] = [data].[AzureManagedInstance_Agent_Job_Keys].[Id]
