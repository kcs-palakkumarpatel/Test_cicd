CREATE FUNCTION [data].[AzureManagedInstance_Database_File_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AzureManagedInstance_Database_File_UnstableSamples] ON [data].[AzureManagedInstance_Database_File_UnstableSamples].[Id] = [data].[AzureManagedInstance_Database_File_Keys].[Id]
