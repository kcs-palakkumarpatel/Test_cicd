CREATE FUNCTION [data].[AzureManagedInstance_Database_CustomMetric_StableSamples_Removable]
(
...
INNER JOIN [data].[AzureManagedInstance_Database_CustomMetric_StableSamples] ON [data].[AzureManagedInstance_Database_CustomMetric_StableSamples].[Id] = [data].[AzureManagedInstance_Database_CustomMetric_Keys].[Id]
