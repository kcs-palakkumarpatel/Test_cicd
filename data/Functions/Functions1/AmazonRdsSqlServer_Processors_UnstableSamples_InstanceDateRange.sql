CREATE FUNCTION [data].[AmazonRdsSqlServer_Processors_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_CumulativeIdleTime] AS [AmazonRdsSqlServer_Processors_CumulativeIdleTime]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_CumulativeIdleTime]
    FROM [data].[AmazonRdsSqlServer_Processors_UnstableSamples]
