CREATE FUNCTION [data].[AzureManagedInstance_Permissions_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AzureManagedInstance_Permissions_UnstableSamples] ON [data].[AzureManagedInstance_Permissions_UnstableSamples].[Id] = [data].[AzureManagedInstance_Keys].[Id]
