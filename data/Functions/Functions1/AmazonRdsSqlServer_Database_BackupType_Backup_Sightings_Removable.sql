CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_BackupType_Backup_Sightings_Removable]
(
...
SELECT [data].[AmazonRdsSqlServer_Database_BackupType_Backup_Sightings].[SightingDate], [data].[AmazonRdsSqlServer_Database_BackupType_Backup_Sightings].[Id]
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_BackupType_Backup_Sightings] ON [data].[AmazonRdsSqlServer_Database_BackupType_Backup_Sightings].[Id] = [data].[AmazonRdsSqlServer_Database_BackupType_Backup_Keys].[Id]
