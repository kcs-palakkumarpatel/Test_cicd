CREATE FUNCTION [data].[AzureManagedInstance_Database_Table_Index_Sightings_Removable]
(
...
SELECT [data].[AzureManagedInstance_Database_Table_Index_Sightings].[SightingDate], [data].[AzureManagedInstance_Database_Table_Index_Sightings].[Id]
...
INNER JOIN [data].[AzureManagedInstance_Database_Table_Index_Sightings] ON [data].[AzureManagedInstance_Database_Table_Index_Sightings].[Id] = [data].[AzureManagedInstance_Database_Table_Index_Keys].[Id]
