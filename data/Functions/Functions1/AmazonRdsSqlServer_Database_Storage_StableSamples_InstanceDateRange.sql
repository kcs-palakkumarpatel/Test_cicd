CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_Storage_StableSamples_InstanceDateRange]
(
...
, [Leaf].[_TotalDataSizeBytes] AS [AmazonRdsSqlServer_Database_Storage_TotalDataSizeBytes]
, [Leaf].[_TotalLogSizeBytes] AS [AmazonRdsSqlServer_Database_Storage_TotalLogSizeBytes]
FROM
 [SightedInstances]
LEFT OUTER JOIN
(
    SELECT [Id], MAX([CollectionDate]) as [GreatestMinDate]
    FROM [data].[AmazonRdsSqlServer_Database_Storage_StableSamples]
...
INNER JOIN
 [data].[AmazonRdsSqlServer_Database_Storage_StableSamples] [Leaf]
