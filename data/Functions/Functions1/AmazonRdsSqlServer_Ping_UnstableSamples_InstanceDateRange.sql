CREATE FUNCTION [data].[AmazonRdsSqlServer_Ping_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_RoundtripTime] AS [AmazonRdsSqlServer_Ping_RoundtripTime]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_RoundtripTime]
    FROM [data].[AmazonRdsSqlServer_Ping_UnstableSamples]
