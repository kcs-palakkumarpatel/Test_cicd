CREATE FUNCTION [data].[AzureManagedInstance_Agent_Job_Activity_Sightings_Removable]
(
...
SELECT [data].[AzureManagedInstance_Agent_Job_Activity_Sightings].[SightingDate], [data].[AzureManagedInstance_Agent_Job_Activity_Sightings].[Id]
...
INNER JOIN [data].[AzureManagedInstance_Agent_Job_Activity_Sightings] ON [data].[AzureManagedInstance_Agent_Job_Activity_Sightings].[Id] = [data].[AzureManagedInstance_Agent_Job_Activity_Keys].[Id]
