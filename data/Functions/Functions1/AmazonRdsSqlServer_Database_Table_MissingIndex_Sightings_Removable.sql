CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_Table_MissingIndex_Sightings_Removable]
(
...
SELECT [data].[AmazonRdsSqlServer_Database_Table_MissingIndex_Sightings].[SightingDate], [data].[AmazonRdsSqlServer_Database_Table_MissingIndex_Sightings].[Id]
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_Table_MissingIndex_Sightings] ON [data].[AmazonRdsSqlServer_Database_Table_MissingIndex_Sightings].[Id] = [data].[AmazonRdsSqlServer_Database_Table_MissingIndex_Keys].[Id]
