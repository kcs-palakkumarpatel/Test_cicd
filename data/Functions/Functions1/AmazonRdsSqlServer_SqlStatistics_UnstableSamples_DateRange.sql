CREATE FUNCTION [data].[AmazonRdsSqlServer_SqlStatistics_UnstableSamples_DateRange]
(
    @MinDate AS BIGINT
    , @MaxDate AS BIGINT
    , @MaxSamples AS INT
...
, [Leaf].[_CumulativeBatchRequests] AS [AmazonRdsSqlServer_SqlStatistics_CumulativeBatchRequests]
, [Leaf].[_CumulativeCompilations] AS [AmazonRdsSqlServer_SqlStatistics_CumulativeCompilations]
, [Leaf].[_CumulativeRecompilations] AS [AmazonRdsSqlServer_SqlStatistics_CumulativeRecompilations]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    FROM [data].[AmazonRdsSqlServer_SqlStatistics_UnstableSamples]
