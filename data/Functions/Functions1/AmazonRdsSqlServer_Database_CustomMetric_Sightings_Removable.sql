CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_CustomMetric_Sightings_Removable]
(
...
SELECT [data].[AmazonRdsSqlServer_Database_CustomMetric_Sightings].[SightingDate], [data].[AmazonRdsSqlServer_Database_CustomMetric_Sightings].[Id]
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_CustomMetric_Sightings] ON [data].[AmazonRdsSqlServer_Database_CustomMetric_Sightings].[Id] = [data].[AmazonRdsSqlServer_Database_CustomMetric_Keys].[Id]
