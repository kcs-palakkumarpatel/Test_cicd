CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_StoredProcedure_ParentSP_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_StoredProcedure_ParentSP_UnstableSamples] ON [data].[AmazonRdsSqlServer_Database_StoredProcedure_ParentSP_UnstableSamples].[Id] = [data].[AmazonRdsSqlServer_Database_StoredProcedure_ParentSP_Keys].[Id]
