CREATE FUNCTION [data].[AzureManagedInstance_Database_CustomMetric_UnstableSamples_DateRange]
(
    @MinDate AS BIGINT
    , @MaxDate AS BIGINT
    , @MaxSamples AS INT
...
, [Leaf].[_Value] AS [AzureManagedInstance_Database_CustomMetric_Value]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_Value]
    FROM [data].[AzureManagedInstance_Database_CustomMetric_UnstableSamples]
