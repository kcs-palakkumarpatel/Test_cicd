CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_Encryption_StableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_Encryption_StableSamples] ON [data].[AmazonRdsSqlServer_Database_Encryption_StableSamples].[Id] = [data].[AmazonRdsSqlServer_Database_Keys].[Id]
