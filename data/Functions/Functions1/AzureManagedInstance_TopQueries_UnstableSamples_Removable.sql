CREATE FUNCTION [data].[AzureManagedInstance_TopQueries_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AzureManagedInstance_TopQueries_UnstableSamples] ON [data].[AzureManagedInstance_TopQueries_UnstableSamples].[Id] = [data].[AzureManagedInstance_TopQueries_Keys].[Id]
