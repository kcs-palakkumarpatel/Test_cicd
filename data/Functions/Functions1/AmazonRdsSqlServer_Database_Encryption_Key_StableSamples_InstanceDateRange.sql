CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_Encryption_Key_StableSamples_InstanceDateRange]
(
...
, [Leaf].[_Algorithm] AS [AmazonRdsSqlServer_Database_Encryption_Key_Algorithm]
, [Leaf].[_EncryptionType] AS [AmazonRdsSqlServer_Database_Encryption_Key_EncryptionType]
, [Leaf].[_Name] AS [AmazonRdsSqlServer_Database_Encryption_Key_Name]
FROM
 [SightedInstances]
LEFT OUTER JOIN
(
    SELECT [Id], MAX([CollectionDate]) as [GreatestMinDate]
    FROM [data].[AmazonRdsSqlServer_Database_Encryption_Key_StableSamples]
...
INNER JOIN
 [data].[AmazonRdsSqlServer_Database_Encryption_Key_StableSamples] [Leaf]
