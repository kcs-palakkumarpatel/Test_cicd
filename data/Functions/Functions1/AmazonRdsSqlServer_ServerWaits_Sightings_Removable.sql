CREATE FUNCTION [data].[AmazonRdsSqlServer_ServerWaits_Sightings_Removable]
(
...
SELECT [data].[AmazonRdsSqlServer_ServerWaits_Sightings].[SightingDate], [data].[AmazonRdsSqlServer_ServerWaits_Sightings].[Id]
...
INNER JOIN [data].[AmazonRdsSqlServer_ServerWaits_Sightings] ON [data].[AmazonRdsSqlServer_ServerWaits_Sightings].[Id] = [data].[AmazonRdsSqlServer_ServerWaits_Keys].[Id]
