CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_BackupType_Sightings_Removable]
(
...
SELECT [data].[AmazonRdsSqlServer_Database_BackupType_Sightings].[SightingDate], [data].[AmazonRdsSqlServer_Database_BackupType_Sightings].[Id]
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_BackupType_Sightings] ON [data].[AmazonRdsSqlServer_Database_BackupType_Sightings].[Id] = [data].[AmazonRdsSqlServer_Database_BackupType_Keys].[Id]
