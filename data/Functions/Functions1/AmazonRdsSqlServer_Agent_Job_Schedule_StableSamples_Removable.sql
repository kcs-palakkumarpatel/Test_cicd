CREATE FUNCTION [data].[AmazonRdsSqlServer_Agent_Job_Schedule_StableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_Agent_Job_Schedule_StableSamples] ON [data].[AmazonRdsSqlServer_Agent_Job_Schedule_StableSamples].[Id] = [data].[AmazonRdsSqlServer_Agent_Job_Keys].[Id]
