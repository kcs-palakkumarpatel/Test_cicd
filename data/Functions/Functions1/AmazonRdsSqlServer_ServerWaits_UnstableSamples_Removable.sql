CREATE FUNCTION [data].[AmazonRdsSqlServer_ServerWaits_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_ServerWaits_UnstableSamples] ON [data].[AmazonRdsSqlServer_ServerWaits_UnstableSamples].[Id] = [data].[AmazonRdsSqlServer_ServerWaits_Keys].[Id]
