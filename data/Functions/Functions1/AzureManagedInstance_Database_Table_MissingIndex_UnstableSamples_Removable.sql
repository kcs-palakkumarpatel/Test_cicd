CREATE FUNCTION [data].[AzureManagedInstance_Database_Table_MissingIndex_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AzureManagedInstance_Database_Table_MissingIndex_UnstableSamples] ON [data].[AzureManagedInstance_Database_Table_MissingIndex_UnstableSamples].[Id] = [data].[AzureManagedInstance_Database_Table_MissingIndex_Keys].[Id]
