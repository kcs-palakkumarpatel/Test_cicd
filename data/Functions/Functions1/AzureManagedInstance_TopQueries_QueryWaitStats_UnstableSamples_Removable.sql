CREATE FUNCTION [data].[AzureManagedInstance_TopQueries_QueryWaitStats_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AzureManagedInstance_TopQueries_QueryWaitStats_UnstableSamples] ON [data].[AzureManagedInstance_TopQueries_QueryWaitStats_UnstableSamples].[Id] = [data].[AzureManagedInstance_TopQueries_QueryWaitStats_Keys].[Id]
