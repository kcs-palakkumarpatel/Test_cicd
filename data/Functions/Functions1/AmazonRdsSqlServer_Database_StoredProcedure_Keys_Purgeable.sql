CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_StoredProcedure_Keys_Purgeable]
(
    @PurgeDate AS BIGINT
)
RETURNS TABLE
...
SELECT
    [data].[AmazonRdsSqlServer_Database_StoredProcedure_Keys].[Id]
FROM
...
(
    SELECT
        [Id]
    FROM
        [data].[AmazonRdsSqlServer_Database_StoredProcedure_Sightings]
    WHERE
