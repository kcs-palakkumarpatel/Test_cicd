CREATE FUNCTION [data].[AmazonRdsSqlServer_Memory_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_Memory_UnstableSamples] ON [data].[AmazonRdsSqlServer_Memory_UnstableSamples].[Id] = [data].[AmazonRdsSqlServer_Keys].[Id]
