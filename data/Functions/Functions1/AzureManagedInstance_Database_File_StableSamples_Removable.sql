CREATE FUNCTION [data].[AzureManagedInstance_Database_File_StableSamples_Removable]
(
...
INNER JOIN [data].[AzureManagedInstance_Database_File_StableSamples] ON [data].[AzureManagedInstance_Database_File_StableSamples].[Id] = [data].[AzureManagedInstance_Database_File_Keys].[Id]
