CREATE FUNCTION [data].[AzureManagedInstance_GeneralStatistics_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_UserConnections] AS [AzureManagedInstance_GeneralStatistics_UserConnections]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_UserConnections]
    FROM [data].[AzureManagedInstance_GeneralStatistics_UnstableSamples]
