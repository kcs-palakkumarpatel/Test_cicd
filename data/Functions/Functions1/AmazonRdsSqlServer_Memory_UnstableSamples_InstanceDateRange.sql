CREATE FUNCTION [data].[AmazonRdsSqlServer_Memory_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_FreeBytes] AS [AmazonRdsSqlServer_Memory_FreeBytes]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_FreeBytes]
    FROM [data].[AmazonRdsSqlServer_Memory_UnstableSamples]
