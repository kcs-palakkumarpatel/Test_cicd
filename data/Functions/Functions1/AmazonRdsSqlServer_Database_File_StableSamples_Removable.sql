CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_File_StableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_File_StableSamples] ON [data].[AmazonRdsSqlServer_Database_File_StableSamples].[Id] = [data].[AmazonRdsSqlServer_Database_File_Keys].[Id]
