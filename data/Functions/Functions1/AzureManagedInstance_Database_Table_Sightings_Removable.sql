CREATE FUNCTION [data].[AzureManagedInstance_Database_Table_Sightings_Removable]
(
...
SELECT [data].[AzureManagedInstance_Database_Table_Sightings].[SightingDate], [data].[AzureManagedInstance_Database_Table_Sightings].[Id]
...
INNER JOIN [data].[AzureManagedInstance_Database_Table_Sightings] ON [data].[AzureManagedInstance_Database_Table_Sightings].[Id] = [data].[AzureManagedInstance_Database_Table_Keys].[Id]
