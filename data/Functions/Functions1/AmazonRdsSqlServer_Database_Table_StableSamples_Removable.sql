CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_Table_StableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_Table_StableSamples] ON [data].[AmazonRdsSqlServer_Database_Table_StableSamples].[Id] = [data].[AmazonRdsSqlServer_Database_Table_Keys].[Id]
