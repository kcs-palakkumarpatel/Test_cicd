CREATE FUNCTION [data].[AmazonRdsSqlServer_Permissions_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_Data] AS [AmazonRdsSqlServer_Permissions_Data]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_Data]
    FROM [data].[AmazonRdsSqlServer_Permissions_UnstableSamples]
