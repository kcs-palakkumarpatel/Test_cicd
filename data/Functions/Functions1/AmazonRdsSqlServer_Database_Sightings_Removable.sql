CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_Sightings_Removable]
(
...
SELECT [data].[AmazonRdsSqlServer_Database_Sightings].[SightingDate], [data].[AmazonRdsSqlServer_Database_Sightings].[Id]
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_Sightings] ON [data].[AmazonRdsSqlServer_Database_Sightings].[Id] = [data].[AmazonRdsSqlServer_Database_Keys].[Id]
