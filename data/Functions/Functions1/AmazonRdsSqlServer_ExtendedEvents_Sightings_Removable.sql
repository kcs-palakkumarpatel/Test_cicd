CREATE FUNCTION [data].[AmazonRdsSqlServer_ExtendedEvents_Sightings_Removable]
(
...
SELECT [data].[AmazonRdsSqlServer_ExtendedEvents_Sightings].[SightingDate], [data].[AmazonRdsSqlServer_ExtendedEvents_Sightings].[Id]
...
INNER JOIN [data].[AmazonRdsSqlServer_ExtendedEvents_Sightings] ON [data].[AmazonRdsSqlServer_ExtendedEvents_Sightings].[Id] = [data].[AmazonRdsSqlServer_ExtendedEvents_Keys].[Id]
