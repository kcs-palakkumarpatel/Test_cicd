CREATE FUNCTION [data].[AzureManagedInstance_Database_ConfigurationOptions_Sightings_Removable]
(
...
SELECT [data].[AzureManagedInstance_Database_ConfigurationOptions_Sightings].[SightingDate], [data].[AzureManagedInstance_Database_ConfigurationOptions_Sightings].[Id]
...
INNER JOIN [data].[AzureManagedInstance_Database_ConfigurationOptions_Sightings] ON [data].[AzureManagedInstance_Database_ConfigurationOptions_Sightings].[Id] = [data].[AzureManagedInstance_Database_ConfigurationOptions_Keys].[Id]
