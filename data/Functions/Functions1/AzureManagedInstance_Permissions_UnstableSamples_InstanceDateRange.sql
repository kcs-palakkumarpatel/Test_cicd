CREATE FUNCTION [data].[AzureManagedInstance_Permissions_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_Data] AS [AzureManagedInstance_Permissions_Data]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_Data]
    FROM [data].[AzureManagedInstance_Permissions_UnstableSamples]
