CREATE FUNCTION [data].[AmazonRdsSqlServer_SqlProcess_Sightings_Removable]
(
...
SELECT [data].[AmazonRdsSqlServer_SqlProcess_Sightings].[SightingDate], [data].[AmazonRdsSqlServer_SqlProcess_Sightings].[Id]
...
INNER JOIN [data].[AmazonRdsSqlServer_SqlProcess_Sightings] ON [data].[AmazonRdsSqlServer_SqlProcess_Sightings].[Id] = [data].[AmazonRdsSqlServer_SqlProcess_Keys].[Id]
