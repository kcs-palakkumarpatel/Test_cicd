CREATE FUNCTION [data].[AzureManagedInstance_Database_Encryption_Key_Sightings_Removable]
(
...
SELECT [data].[AzureManagedInstance_Database_Encryption_Key_Sightings].[SightingDate], [data].[AzureManagedInstance_Database_Encryption_Key_Sightings].[Id]
...
INNER JOIN [data].[AzureManagedInstance_Database_Encryption_Key_Sightings] ON [data].[AzureManagedInstance_Database_Encryption_Key_Sightings].[Id] = [data].[AzureManagedInstance_Database_Encryption_Key_Keys].[Id]
