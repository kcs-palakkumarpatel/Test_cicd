CREATE FUNCTION [data].[AmazonRdsSqlServer_GeneralStatistics_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_UserConnections] AS [AmazonRdsSqlServer_GeneralStatistics_UserConnections]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_UserConnections]
    FROM [data].[AmazonRdsSqlServer_GeneralStatistics_UnstableSamples]
