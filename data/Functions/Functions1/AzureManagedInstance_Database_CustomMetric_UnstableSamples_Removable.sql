CREATE FUNCTION [data].[AzureManagedInstance_Database_CustomMetric_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AzureManagedInstance_Database_CustomMetric_UnstableSamples] ON [data].[AzureManagedInstance_Database_CustomMetric_UnstableSamples].[Id] = [data].[AzureManagedInstance_Database_CustomMetric_Keys].[Id]
