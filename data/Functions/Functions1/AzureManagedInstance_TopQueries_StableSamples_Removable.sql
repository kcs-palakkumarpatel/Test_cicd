CREATE FUNCTION [data].[AzureManagedInstance_TopQueries_StableSamples_Removable]
(
...
INNER JOIN [data].[AzureManagedInstance_TopQueries_StableSamples] ON [data].[AzureManagedInstance_TopQueries_StableSamples].[Id] = [data].[AzureManagedInstance_TopQueries_Keys].[Id]
