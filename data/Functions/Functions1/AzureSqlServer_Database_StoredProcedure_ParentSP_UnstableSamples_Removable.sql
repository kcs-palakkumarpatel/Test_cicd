CREATE FUNCTION [data].[AzureSqlServer_Database_StoredProcedure_ParentSP_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AzureSqlServer_Database_StoredProcedure_ParentSP_UnstableSamples] ON [data].[AzureSqlServer_Database_StoredProcedure_ParentSP_UnstableSamples].[Id] = [data].[AzureSqlServer_Database_StoredProcedure_ParentSP_Keys].[Id]
