CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_Encryption_Key_Sightings_Removable]
(
...
SELECT [data].[AmazonRdsSqlServer_Database_Encryption_Key_Sightings].[SightingDate], [data].[AmazonRdsSqlServer_Database_Encryption_Key_Sightings].[Id]
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_Encryption_Key_Sightings] ON [data].[AmazonRdsSqlServer_Database_Encryption_Key_Sightings].[Id] = [data].[AmazonRdsSqlServer_Database_Encryption_Key_Keys].[Id]
