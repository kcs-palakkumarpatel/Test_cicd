CREATE FUNCTION [data].[AmazonRdsSqlServer_Error_Instances_TopEvents]
(
    @MinDate AS BIGINT
    , @MaxDate AS BIGINT
...
, [data].[AmazonRdsSqlServer_Error_Instances].[CollectionDate]
, [utils].[TicksToDateTime]([data].[AmazonRdsSqlServer_Error_Instances].[CollectionDate]) AS [CollectionDate_DateTime]
, [data].[AmazonRdsSqlServer_Error_Instances].[_ProcessInfo] AS [AmazonRdsSqlServer_Error_ProcessInfo]
, [data].[AmazonRdsSqlServer_Error_Instances].[_Text] AS [AmazonRdsSqlServer_Error_Text]
FROM [TopInstances]
INNER JOIN [data].[AmazonRdsSqlServer_Error_Instances]
 ON [TopInstances].[Id] = [data].[AmazonRdsSqlServer_Error_Instances].[Id]