CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_File_Projection_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_File_Projection_UnstableSamples] ON [data].[AmazonRdsSqlServer_Database_File_Projection_UnstableSamples].[Id] = [data].[AmazonRdsSqlServer_Database_File_Keys].[Id]
