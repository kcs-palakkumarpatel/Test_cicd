CREATE FUNCTION [data].[AzureManagedInstance_Database_File_Sightings_Removable]
(
...
SELECT [data].[AzureManagedInstance_Database_File_Sightings].[SightingDate], [data].[AzureManagedInstance_Database_File_Sightings].[Id]
...
INNER JOIN [data].[AzureManagedInstance_Database_File_Sightings] ON [data].[AzureManagedInstance_Database_File_Sightings].[Id] = [data].[AzureManagedInstance_Database_File_Keys].[Id]
