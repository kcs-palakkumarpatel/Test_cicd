CREATE FUNCTION [data].[AmazonRdsSqlServer_TopQueries_StableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_TopQueries_StableSamples] ON [data].[AmazonRdsSqlServer_TopQueries_StableSamples].[Id] = [data].[AmazonRdsSqlServer_TopQueries_Keys].[Id]
