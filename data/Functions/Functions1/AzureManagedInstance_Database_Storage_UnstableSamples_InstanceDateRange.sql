CREATE FUNCTION [data].[AzureManagedInstance_Database_Storage_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_TotalDataUsedBytes] AS [AzureManagedInstance_Database_Storage_TotalDataUsedBytes]
, [Leaf].[_TotalLogUsedBytes] AS [AzureManagedInstance_Database_Storage_TotalLogUsedBytes]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    , [_TotalDataUsedBytes]
    , [_TotalLogUsedBytes]
    FROM [data].[AzureManagedInstance_Database_Storage_UnstableSamples]
