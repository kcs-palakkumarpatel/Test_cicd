CREATE FUNCTION [data].[AmazonRdsSqlServer_TopQueries_QueryWaitStats_StableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_TopQueries_QueryWaitStats_StableSamples] ON [data].[AmazonRdsSqlServer_TopQueries_QueryWaitStats_StableSamples].[Id] = [data].[AmazonRdsSqlServer_TopQueries_QueryWaitStats_Keys].[Id]
