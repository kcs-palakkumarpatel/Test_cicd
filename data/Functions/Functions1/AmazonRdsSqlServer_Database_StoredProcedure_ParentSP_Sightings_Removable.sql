CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_StoredProcedure_ParentSP_Sightings_Removable]
(
...
SELECT [data].[AmazonRdsSqlServer_Database_StoredProcedure_ParentSP_Sightings].[SightingDate], [data].[AmazonRdsSqlServer_Database_StoredProcedure_ParentSP_Sightings].[Id]
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_StoredProcedure_ParentSP_Sightings] ON [data].[AmazonRdsSqlServer_Database_StoredProcedure_ParentSP_Sightings].[Id] = [data].[AmazonRdsSqlServer_Database_StoredProcedure_ParentSP_Keys].[Id]
