CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_Table_Index_Sightings_Removable]
(
...
SELECT [data].[AmazonRdsSqlServer_Database_Table_Index_Sightings].[SightingDate], [data].[AmazonRdsSqlServer_Database_Table_Index_Sightings].[Id]
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_Table_Index_Sightings] ON [data].[AmazonRdsSqlServer_Database_Table_Index_Sightings].[Id] = [data].[AmazonRdsSqlServer_Database_Table_Index_Keys].[Id]
