CREATE FUNCTION [data].[AzureManagedInstance_Database_Table_StableSamples_Removable]
(
...
INNER JOIN [data].[AzureManagedInstance_Database_Table_StableSamples] ON [data].[AzureManagedInstance_Database_Table_StableSamples].[Id] = [data].[AzureManagedInstance_Database_Table_Keys].[Id]
