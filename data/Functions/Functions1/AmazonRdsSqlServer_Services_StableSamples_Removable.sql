CREATE FUNCTION [data].[AmazonRdsSqlServer_Services_StableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_Services_StableSamples] ON [data].[AmazonRdsSqlServer_Services_StableSamples].[Id] = [data].[AmazonRdsSqlServer_Services_Keys].[Id]
