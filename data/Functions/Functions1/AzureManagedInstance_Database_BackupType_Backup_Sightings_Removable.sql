CREATE FUNCTION [data].[AzureManagedInstance_Database_BackupType_Backup_Sightings_Removable]
(
...
SELECT [data].[AzureManagedInstance_Database_BackupType_Backup_Sightings].[SightingDate], [data].[AzureManagedInstance_Database_BackupType_Backup_Sightings].[Id]
...
INNER JOIN [data].[AzureManagedInstance_Database_BackupType_Backup_Sightings] ON [data].[AzureManagedInstance_Database_BackupType_Backup_Sightings].[Id] = [data].[AzureManagedInstance_Database_BackupType_Backup_Keys].[Id]
 ...
 AND  (@AzureManagedInstance_Database_BackupType_Backup_StartDate IS NULL OR [data].[AzureManagedInstance_Database_BackupType_Backup_Keys].[_StartDate] = @AzureManagedInstance_Database_BackupType_Backup_StartDate)