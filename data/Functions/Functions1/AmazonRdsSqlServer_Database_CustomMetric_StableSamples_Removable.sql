CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_CustomMetric_StableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_CustomMetric_StableSamples] ON [data].[AmazonRdsSqlServer_Database_CustomMetric_StableSamples].[Id] = [data].[AmazonRdsSqlServer_Database_CustomMetric_Keys].[Id]
