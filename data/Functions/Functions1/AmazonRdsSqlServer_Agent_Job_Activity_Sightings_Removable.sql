CREATE FUNCTION [data].[AmazonRdsSqlServer_Agent_Job_Activity_Sightings_Removable]
(
...
SELECT [data].[AmazonRdsSqlServer_Agent_Job_Activity_Sightings].[SightingDate], [data].[AmazonRdsSqlServer_Agent_Job_Activity_Sightings].[Id]
...
INNER JOIN [data].[AmazonRdsSqlServer_Agent_Job_Activity_Sightings] ON [data].[AmazonRdsSqlServer_Agent_Job_Activity_Sightings].[Id] = [data].[AmazonRdsSqlServer_Agent_Job_Activity_Keys].[Id]
