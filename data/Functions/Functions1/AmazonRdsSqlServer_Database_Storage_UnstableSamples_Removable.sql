CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_Storage_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_Storage_UnstableSamples] ON [data].[AmazonRdsSqlServer_Database_Storage_UnstableSamples].[Id] = [data].[AmazonRdsSqlServer_Database_Keys].[Id]
