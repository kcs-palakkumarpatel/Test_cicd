CREATE FUNCTION [data].[AmazonRdsSqlServer_TopQueries_Sightings_Removable]
(
...
SELECT [data].[AmazonRdsSqlServer_TopQueries_Sightings].[SightingDate], [data].[AmazonRdsSqlServer_TopQueries_Sightings].[Id]
...
INNER JOIN [data].[AmazonRdsSqlServer_TopQueries_Sightings] ON [data].[AmazonRdsSqlServer_TopQueries_Sightings].[Id] = [data].[AmazonRdsSqlServer_TopQueries_Keys].[Id]
