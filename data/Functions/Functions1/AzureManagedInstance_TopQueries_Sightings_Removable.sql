CREATE FUNCTION [data].[AzureManagedInstance_TopQueries_Sightings_Removable]
(
...
SELECT [data].[AzureManagedInstance_TopQueries_Sightings].[SightingDate], [data].[AzureManagedInstance_TopQueries_Sightings].[Id]
...
INNER JOIN [data].[AzureManagedInstance_TopQueries_Sightings] ON [data].[AzureManagedInstance_TopQueries_Sightings].[Id] = [data].[AzureManagedInstance_TopQueries_Keys].[Id]
