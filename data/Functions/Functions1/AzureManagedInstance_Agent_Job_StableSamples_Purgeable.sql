CREATE FUNCTION [data].[AzureManagedInstance_Agent_Job_StableSamples_Purgeable]
(
    @PurgeDate AS BIGINT
)
RETURNS TABLE
    ...
    (
        ...
        SELECT
            ...
            (
                ...
                FROM [data].[AzureManagedInstance_Agent_Job_StableSamples] [Dates]
...
INNER JOIN [data].[AzureManagedInstance_Agent_Job_StableSamples] ON [data].[AzureManagedInstance_Agent_Job_StableSamples].[Id] = [SightedIdsWithLastDates].[Id]
WHERE [data].[AzureManagedInstance_Agent_Job_StableSamples].[CollectionDate] < [SightedIdsWithLastDates].[LastDate]