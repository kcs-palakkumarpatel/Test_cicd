CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_Storage_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_TotalDataUsedBytes] AS [AmazonRdsSqlServer_Database_Storage_TotalDataUsedBytes]
, [Leaf].[_TotalLogUsedBytes] AS [AmazonRdsSqlServer_Database_Storage_TotalLogUsedBytes]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    , [_TotalDataUsedBytes]
    , [_TotalLogUsedBytes]
    FROM [data].[AmazonRdsSqlServer_Database_Storage_UnstableSamples]
