CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_StableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_StableSamples] ON [data].[AmazonRdsSqlServer_Database_StableSamples].[Id] = [data].[AmazonRdsSqlServer_Database_Keys].[Id]
