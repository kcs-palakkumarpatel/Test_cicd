CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_StoredProcedure_Sightings_Removable]
(
...
SELECT [data].[AmazonRdsSqlServer_Database_StoredProcedure_Sightings].[SightingDate], [data].[AmazonRdsSqlServer_Database_StoredProcedure_Sightings].[Id]
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_StoredProcedure_Sightings] ON [data].[AmazonRdsSqlServer_Database_StoredProcedure_Sightings].[Id] = [data].[AmazonRdsSqlServer_Database_StoredProcedure_Keys].[Id]
