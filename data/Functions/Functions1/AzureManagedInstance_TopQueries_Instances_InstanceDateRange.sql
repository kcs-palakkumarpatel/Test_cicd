CREATE FUNCTION [data].[AzureManagedInstance_TopQueries_Instances_InstanceDateRange]
(
...
, [Leaf].[_ObjectName] AS [AzureManagedInstance_TopQueries_ObjectName]
, [Leaf].[_QueryText] AS [AzureManagedInstance_TopQueries_QueryText]
FROM
 [SightedInstances]
INNER JOIN
 [data].[AzureManagedInstance_TopQueries_Instances] [Leaf]
