CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_Table_MissingIndex_Plans_Instances_InstanceDateRange]
(
...
, [Leaf].[_PlanHandle] AS [AmazonRdsSqlServer_Database_Table_MissingIndex_Plans_PlanHandle]
FROM
 [SightedInstances]
INNER JOIN
 [data].[AmazonRdsSqlServer_Database_Table_MissingIndex_Plans_Instances] [Leaf]
