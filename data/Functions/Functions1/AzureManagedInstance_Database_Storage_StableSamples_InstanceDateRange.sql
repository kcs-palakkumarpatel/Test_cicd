CREATE FUNCTION [data].[AzureManagedInstance_Database_Storage_StableSamples_InstanceDateRange]
(
...
, [Leaf].[_TotalDataSizeBytes] AS [AzureManagedInstance_Database_Storage_TotalDataSizeBytes]
, [Leaf].[_TotalLogSizeBytes] AS [AzureManagedInstance_Database_Storage_TotalLogSizeBytes]
FROM
 [SightedInstances]
LEFT OUTER JOIN
(
    SELECT [Id], MAX([CollectionDate]) as [GreatestMinDate]
    FROM [data].[AzureManagedInstance_Database_Storage_StableSamples]
...
INNER JOIN
 [data].[AzureManagedInstance_Database_Storage_StableSamples] [Leaf]
