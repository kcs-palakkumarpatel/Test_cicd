CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_CustomMetric_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_CustomMetric_UnstableSamples] ON [data].[AmazonRdsSqlServer_Database_CustomMetric_UnstableSamples].[Id] = [data].[AmazonRdsSqlServer_Database_CustomMetric_Keys].[Id]
