CREATE FUNCTION [data].[AzureManagedInstance_Error_Instances_TopEvents]
(
    @MinDate AS BIGINT
    , @MaxDate AS BIGINT
...
, [data].[AzureManagedInstance_Error_Instances].[CollectionDate]
, [utils].[TicksToDateTime]([data].[AzureManagedInstance_Error_Instances].[CollectionDate]) AS [CollectionDate_DateTime]
, [data].[AzureManagedInstance_Error_Instances].[_ProcessInfo] AS [AzureManagedInstance_Error_ProcessInfo]
, [data].[AzureManagedInstance_Error_Instances].[_Text] AS [AzureManagedInstance_Error_Text]
FROM [TopInstances]
INNER JOIN [data].[AzureManagedInstance_Error_Instances]
 ON [TopInstances].[Id] = [data].[AzureManagedInstance_Error_Instances].[Id]