CREATE FUNCTION [data].[AzureManagedInstance_Database_StoredProc_Sightings_Removable]
(
...
SELECT [data].[AzureManagedInstance_Database_StoredProc_Sightings].[SightingDate], [data].[AzureManagedInstance_Database_StoredProc_Sightings].[Id]
...
INNER JOIN [data].[AzureManagedInstance_Database_StoredProc_Sightings] ON [data].[AzureManagedInstance_Database_StoredProc_Sightings].[Id] = [data].[AzureManagedInstance_Database_StoredProc_Keys].[Id]
