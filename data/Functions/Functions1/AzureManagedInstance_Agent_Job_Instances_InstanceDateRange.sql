CREATE FUNCTION [data].[AzureManagedInstance_Agent_Job_Instances_InstanceDateRange]
(
...
, [Leaf].[_DateCreated] AS [AzureManagedInstance_Agent_Job_DateCreated]
, [utils].[TicksToDateTime]([Leaf].[_DateCreated]) AS [AzureManagedInstance_Agent_Job_DateCreated_DateTime]
FROM
 [SightedInstances]
INNER JOIN
 [data].[AzureManagedInstance_Agent_Job_Instances] [Leaf]
