CREATE FUNCTION [data].[AzureManagedInstance_Database_TransactionVersionStore_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_ReservedBytes] AS [AzureManagedInstance_Database_TransactionVersionStore_ReservedBytes]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_ReservedBytes]
    FROM [data].[AzureManagedInstance_Database_TransactionVersionStore_UnstableSamples]
