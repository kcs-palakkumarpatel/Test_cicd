CREATE FUNCTION [data].[AmazonRdsSqlServer_Process_StableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_Process_StableSamples] ON [data].[AmazonRdsSqlServer_Process_StableSamples].[Id] = [data].[AmazonRdsSqlServer_Process_Keys].[Id]
