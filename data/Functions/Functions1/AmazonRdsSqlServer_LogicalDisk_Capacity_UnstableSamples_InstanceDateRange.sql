CREATE FUNCTION [data].[AmazonRdsSqlServer_LogicalDisk_Capacity_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_UsedBytes] AS [AmazonRdsSqlServer_LogicalDisk_Capacity_UsedBytes]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_UsedBytes]
    FROM [data].[AmazonRdsSqlServer_LogicalDisk_Capacity_UnstableSamples]
