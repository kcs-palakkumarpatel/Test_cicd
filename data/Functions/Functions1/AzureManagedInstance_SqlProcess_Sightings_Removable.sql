CREATE FUNCTION [data].[AzureManagedInstance_SqlProcess_Sightings_Removable]
(
...
SELECT [data].[AzureManagedInstance_SqlProcess_Sightings].[SightingDate], [data].[AzureManagedInstance_SqlProcess_Sightings].[Id]
...
INNER JOIN [data].[AzureManagedInstance_SqlProcess_Sightings] ON [data].[AzureManagedInstance_SqlProcess_Sightings].[Id] = [data].[AzureManagedInstance_SqlProcess_Keys].[Id]
