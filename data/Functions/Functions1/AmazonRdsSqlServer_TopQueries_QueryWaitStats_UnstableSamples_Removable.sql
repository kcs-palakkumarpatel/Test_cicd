CREATE FUNCTION [data].[AmazonRdsSqlServer_TopQueries_QueryWaitStats_UnstableSamples_Removable]
(
...
SELECT [data].[AmazonRdsSqlServer_TopQueries_QueryWaitStats_UnstableSamples].[Id], [data].[AmazonRdsSqlServer_TopQueries_QueryWaitStats_UnstableSamples].[CollectionDate]
...
INNER JOIN [data].[AmazonRdsSqlServer_TopQueries_QueryWaitStats_UnstableSamples] ON [data].[AmazonRdsSqlServer_TopQueries_QueryWaitStats_UnstableSamples].[Id] = [data].[AmazonRdsSqlServer_TopQueries_QueryWaitStats_Keys].[Id]
 ...
 AND  (@AmazonRdsSqlServer_TopQueries_QueryWaitStats_WaitType IS NULL OR [data].[AmazonRdsSqlServer_TopQueries_QueryWaitStats_Keys].[_WaitType] = @AmazonRdsSqlServer_TopQueries_QueryWaitStats_WaitType)