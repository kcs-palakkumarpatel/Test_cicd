CREATE FUNCTION [data].[AzureManagedInstance_Database_ConfigurationOptions_Keys_InstanceDateRange]
(
...
AS
RETURN
WITH [SightedInstances]([Id], [ParentId], [IdCollectionDate], [AzureManagedInstance_Name], [AzureManagedInstance_Database_Name], [AzureManagedInstance_Database_ConfigurationOptions_Name]) AS
(
    ...
    INNER JOIN [data].[AzureManagedInstance_Database_ConfigurationOptions_Keys] ON [data].[AzureManagedInstance_Database_ConfigurationOptions_Keys].[ParentId] = [data].[AzureManagedInstance_Database_Keys].[Id]
     ...
     AND [data].[AzureManagedInstance_Database_ConfigurationOptions_Keys].[_Name] = @AzureManagedInstance_Database_ConfigurationOptions_Name
)
SELECT
[SightedInstances].[Id]
