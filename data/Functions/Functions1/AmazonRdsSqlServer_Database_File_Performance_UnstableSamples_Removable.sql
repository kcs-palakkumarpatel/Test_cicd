CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_File_Performance_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_File_Performance_UnstableSamples] ON [data].[AmazonRdsSqlServer_Database_File_Performance_UnstableSamples].[Id] = [data].[AmazonRdsSqlServer_Database_File_Keys].[Id]
