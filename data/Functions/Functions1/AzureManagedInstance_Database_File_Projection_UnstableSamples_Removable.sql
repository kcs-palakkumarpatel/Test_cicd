CREATE FUNCTION [data].[AzureManagedInstance_Database_File_Projection_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AzureManagedInstance_Database_File_Projection_UnstableSamples] ON [data].[AzureManagedInstance_Database_File_Projection_UnstableSamples].[Id] = [data].[AzureManagedInstance_Database_File_Keys].[Id]
