CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_Storage_StableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_Storage_StableSamples] ON [data].[AmazonRdsSqlServer_Database_Storage_StableSamples].[Id] = [data].[AmazonRdsSqlServer_Database_Keys].[Id]
