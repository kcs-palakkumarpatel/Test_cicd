CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_TransactionVersionStore_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_ReservedBytes] AS [AmazonRdsSqlServer_Database_TransactionVersionStore_ReservedBytes]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_ReservedBytes]
    FROM [data].[AmazonRdsSqlServer_Database_TransactionVersionStore_UnstableSamples]
