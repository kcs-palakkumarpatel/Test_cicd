CREATE FUNCTION [data].[AzureManagedInstance_TopQueries_QueryWaitStats_Sightings_Removable]
(
...
SELECT [data].[AzureManagedInstance_TopQueries_QueryWaitStats_Sightings].[SightingDate], [data].[AzureManagedInstance_TopQueries_QueryWaitStats_Sightings].[Id]
...
INNER JOIN [data].[AzureManagedInstance_TopQueries_QueryWaitStats_Sightings] ON [data].[AzureManagedInstance_TopQueries_QueryWaitStats_Sightings].[Id] = [data].[AzureManagedInstance_TopQueries_QueryWaitStats_Keys].[Id]
