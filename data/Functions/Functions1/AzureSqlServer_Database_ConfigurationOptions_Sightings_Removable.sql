CREATE FUNCTION [data].[AzureSqlServer_Database_ConfigurationOptions_Sightings_Removable]
(
...
SELECT [data].[AzureSqlServer_Database_ConfigurationOptions_Sightings].[SightingDate], [data].[AzureSqlServer_Database_ConfigurationOptions_Sightings].[Id]
...
INNER JOIN [data].[AzureSqlServer_Database_ConfigurationOptions_Sightings] ON [data].[AzureSqlServer_Database_ConfigurationOptions_Sightings].[Id] = [data].[AzureSqlServer_Database_ConfigurationOptions_Keys].[Id]
