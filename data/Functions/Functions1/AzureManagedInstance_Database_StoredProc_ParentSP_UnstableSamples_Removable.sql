CREATE FUNCTION [data].[AzureManagedInstance_Database_StoredProc_ParentSP_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AzureManagedInstance_Database_StoredProc_ParentSP_UnstableSamples] ON [data].[AzureManagedInstance_Database_StoredProc_ParentSP_UnstableSamples].[Id] = [data].[AzureManagedInstance_Database_StoredProc_ParentSP_Keys].[Id]
