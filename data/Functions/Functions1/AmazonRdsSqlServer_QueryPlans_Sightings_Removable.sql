CREATE FUNCTION [data].[AmazonRdsSqlServer_QueryPlans_Sightings_Removable]
(
...
SELECT [data].[AmazonRdsSqlServer_QueryPlans_Sightings].[SightingDate], [data].[AmazonRdsSqlServer_QueryPlans_Sightings].[Id]
...
INNER JOIN [data].[AmazonRdsSqlServer_QueryPlans_Sightings] ON [data].[AmazonRdsSqlServer_QueryPlans_Sightings].[Id] = [data].[AmazonRdsSqlServer_QueryPlans_Keys].[Id]
