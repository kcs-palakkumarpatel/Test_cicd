CREATE FUNCTION [data].[AzureManagedInstance_Ping_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_RoundtripTime] AS [AzureManagedInstance_Ping_RoundtripTime]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_RoundtripTime]
    FROM [data].[AzureManagedInstance_Ping_UnstableSamples]
