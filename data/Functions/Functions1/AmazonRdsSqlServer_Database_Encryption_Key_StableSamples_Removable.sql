CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_Encryption_Key_StableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_Encryption_Key_StableSamples] ON [data].[AmazonRdsSqlServer_Database_Encryption_Key_StableSamples].[Id] = [data].[AmazonRdsSqlServer_Database_Encryption_Key_Keys].[Id]
