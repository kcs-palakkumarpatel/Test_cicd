CREATE FUNCTION [data].[AzureManagedInstance_Database_File_Projection_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_Gradient] AS [AzureManagedInstance_Database_File_Projection_Gradient]
, [Leaf].[_Intercept] AS [AzureManagedInstance_Database_File_Projection_Intercept]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    , [_Gradient]
    , [_Intercept]
    FROM [data].[AzureManagedInstance_Database_File_Projection_UnstableSamples]
