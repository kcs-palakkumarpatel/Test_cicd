CREATE FUNCTION [data].[AzureManagedInstance_Database_StableSamples_Removable]
(
...
INNER JOIN [data].[AzureManagedInstance_Database_StableSamples] ON [data].[AzureManagedInstance_Database_StableSamples].[Id] = [data].[AzureManagedInstance_Database_Keys].[Id]
