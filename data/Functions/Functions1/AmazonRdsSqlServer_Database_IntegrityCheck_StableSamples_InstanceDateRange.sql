CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_IntegrityCheck_StableSamples_InstanceDateRange]
(
...
, [Leaf].[_LastIntegrityCheck] AS [AmazonRdsSqlServer_Database_IntegrityCheck_LastIntegrityCheck]
, [utils].[TicksToDateTime]([Leaf].[_LastIntegrityCheck]) AS [AmazonRdsSqlServer_Database_IntegrityCheck_LastIntegrityCheck_DateTime]
FROM
 [SightedInstances]
LEFT OUTER JOIN
(
    SELECT [Id], MAX([CollectionDate]) as [GreatestMinDate]
    FROM [data].[AmazonRdsSqlServer_Database_IntegrityCheck_StableSamples]
...
INNER JOIN
 [data].[AmazonRdsSqlServer_Database_IntegrityCheck_StableSamples] [Leaf]
