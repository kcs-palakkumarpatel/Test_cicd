CREATE FUNCTION [data].[AzureManagedInstance_Database_Table_MissingIndex_Sightings_Removable]
(
...
SELECT [data].[AzureManagedInstance_Database_Table_MissingIndex_Sightings].[SightingDate], [data].[AzureManagedInstance_Database_Table_MissingIndex_Sightings].[Id]
...
INNER JOIN [data].[AzureManagedInstance_Database_Table_MissingIndex_Sightings] ON [data].[AzureManagedInstance_Database_Table_MissingIndex_Sightings].[Id] = [data].[AzureManagedInstance_Database_Table_MissingIndex_Keys].[Id]
