CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_TransactionVersionStore_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AmazonRdsSqlServer_Database_TransactionVersionStore_UnstableSamples] ON [data].[AmazonRdsSqlServer_Database_TransactionVersionStore_UnstableSamples].[Id] = [data].[AmazonRdsSqlServer_Database_Keys].[Id]
