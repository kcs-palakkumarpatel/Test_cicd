CREATE FUNCTION [data].[AzureManagedInstance_Error_Instances_InstanceDateRange]
(
...
, [Leaf].[_ProcessInfo] AS [AzureManagedInstance_Error_ProcessInfo]
, [Leaf].[_Text] AS [AzureManagedInstance_Error_Text]
FROM
 [SightedInstances]
INNER JOIN
 [data].[AzureManagedInstance_Error_Instances] [Leaf]
