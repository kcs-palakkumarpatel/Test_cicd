CREATE FUNCTION [data].[AmazonRdsSqlServer_TopQueries_QueryWaitStats_Sightings_Removable]
(
...
SELECT [data].[AmazonRdsSqlServer_TopQueries_QueryWaitStats_Sightings].[SightingDate], [data].[AmazonRdsSqlServer_TopQueries_QueryWaitStats_Sightings].[Id]
...
INNER JOIN [data].[AmazonRdsSqlServer_TopQueries_QueryWaitStats_Sightings] ON [data].[AmazonRdsSqlServer_TopQueries_QueryWaitStats_Sightings].[Id] = [data].[AmazonRdsSqlServer_TopQueries_QueryWaitStats_Keys].[Id]
