CREATE FUNCTION [data].[AmazonRdsSqlServer_Database_File_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_Size] AS [AmazonRdsSqlServer_Database_File_Size]
, [Leaf].[_UsedSize] AS [AmazonRdsSqlServer_Database_File_UsedSize]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    , [_Size]
    , [_UsedSize]
    FROM [data].[AmazonRdsSqlServer_Database_File_UnstableSamples]
