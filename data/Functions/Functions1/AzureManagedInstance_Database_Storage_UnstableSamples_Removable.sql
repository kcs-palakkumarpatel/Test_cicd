CREATE FUNCTION [data].[AzureManagedInstance_Database_Storage_UnstableSamples_Removable]
(
...
INNER JOIN [data].[AzureManagedInstance_Database_Storage_UnstableSamples] ON [data].[AzureManagedInstance_Database_Storage_UnstableSamples].[Id] = [data].[AzureManagedInstance_Database_Keys].[Id]
