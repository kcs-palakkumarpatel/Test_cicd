CREATE FUNCTION [data].[Cluster_SqlServer_Database_StoredProcedure_Sightings_Removable]
(
...
SELECT [data].[Cluster_SqlServer_Database_StoredProcedure_Sightings].[SightingDate], [data].[Cluster_SqlServer_Database_StoredProcedure_Sightings].[Id]
...
INNER JOIN [data].[Cluster_SqlServer_Database_StoredProcedure_Sightings] ON [data].[Cluster_SqlServer_Database_StoredProcedure_Sightings].[Id] = [data].[Cluster_SqlServer_Database_StoredProcedure_Keys].[Id]
