...
, [Leaf].[_ExecutingProcedure] AS [Cluster_SqlServer_SqlProcess_ExecutingProcedure]
, [Leaf].[_FullCommand] AS [Cluster_SqlServer_SqlProcess_FullCommand]
, [Leaf].[_InternalObjectsAllocBytes] AS [Cluster_SqlServer_SqlProcess_InternalObjectsAllocBytes]
, [Leaf].[_InternalObjectsDeallocBytes] AS [Cluster_SqlServer_SqlProcess_InternalObjectsDeallocBytes]
...
, [Leaf].[_QueryHash] AS [Cluster_SqlServer_SqlProcess_QueryHash]
, [Leaf].[_QueryPlanHash] AS [Cluster_SqlServer_SqlProcess_QueryPlanHash]
...
, [Leaf].[_QueryStartTimeIsCalculated] AS [Cluster_SqlServer_SqlProcess_QueryStartTimeIsCalculated]
...
, [Leaf].[_UserObjectsAllocBytes] AS [Cluster_SqlServer_SqlProcess_UserObjectsAllocBytes]
, [Leaf].[_UserObjectsDeallocBytes] AS [Cluster_SqlServer_SqlProcess_UserObjectsDeallocBytes]
, [Leaf].[_UserObjectsDeferredDeallocBytes] AS [Cluster_SqlServer_SqlProcess_UserObjectsDeferredDeallocBytes]
