CREATE FUNCTION [data].[Cluster_ClusterSharedVolumes_StableSamples_Purgeable]
(
    @PurgeDate AS BIGINT
)
RETURNS TABLE
    ...
    (
        ...
        SELECT
            ...
            (
                ...
                FROM [data].[Cluster_ClusterSharedVolumes_StableSamples] [Dates]
...
INNER JOIN [data].[Cluster_ClusterSharedVolumes_StableSamples] ON [data].[Cluster_ClusterSharedVolumes_StableSamples].[Id] = [SightedIdsWithLastDates].[Id]
WHERE [data].[Cluster_ClusterSharedVolumes_StableSamples].[CollectionDate] < [SightedIdsWithLastDates].[LastDate]