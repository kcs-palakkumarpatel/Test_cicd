CREATE FUNCTION [data].[Cluster_ClusterSharedVolumes_Sightings_Removable]
(
...
SELECT [data].[Cluster_ClusterSharedVolumes_Sightings].[SightingDate], [data].[Cluster_ClusterSharedVolumes_Sightings].[Id]
...
INNER JOIN [data].[Cluster_ClusterSharedVolumes_Sightings] ON [data].[Cluster_ClusterSharedVolumes_Sightings].[Id] = [data].[Cluster_ClusterSharedVolumes_Keys].[Id]
