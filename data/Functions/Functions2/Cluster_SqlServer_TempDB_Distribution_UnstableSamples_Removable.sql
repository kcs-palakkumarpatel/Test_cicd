CREATE FUNCTION [data].[Cluster_SqlServer_TempDB_Distribution_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_TempDB_Distribution_UnstableSamples] ON [data].[Cluster_SqlServer_TempDB_Distribution_UnstableSamples].[Id] = [data].[Cluster_SqlServer_Keys].[Id]
