CREATE FUNCTION [data].[Cluster_SqlServer_MirroringEndpoint_StableSamples_InstanceDateRange]
(
...
AS
RETURN
WITH [SightedInstances]([Id], [ParentId], [IdCollectionDate], [Cluster_Name], [Cluster_SqlServer_Name], [Cluster_SqlServer_MirroringEndpoint_Name]) AS
(
    ...
    INNER JOIN [data].[Cluster_SqlServer_MirroringEndpoint_Keys] ON [data].[Cluster_SqlServer_MirroringEndpoint_Keys].[ParentId] = [data].[Cluster_SqlServer_Keys].[Id]
     ...
     AND [data].[Cluster_SqlServer_MirroringEndpoint_Keys].[_Name] = @Cluster_SqlServer_MirroringEndpoint_Name
)
SELECT
[SightedInstances].[Id]
