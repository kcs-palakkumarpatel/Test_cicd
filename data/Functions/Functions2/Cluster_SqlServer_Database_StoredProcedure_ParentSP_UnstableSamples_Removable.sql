CREATE FUNCTION [data].[Cluster_SqlServer_Database_StoredProcedure_ParentSP_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_Database_StoredProcedure_ParentSP_UnstableSamples] ON [data].[Cluster_SqlServer_Database_StoredProcedure_ParentSP_UnstableSamples].[Id] = [data].[Cluster_SqlServer_Database_StoredProcedure_ParentSP_Keys].[Id]
