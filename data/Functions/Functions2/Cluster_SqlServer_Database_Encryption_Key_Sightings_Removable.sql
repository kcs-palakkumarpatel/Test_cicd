CREATE FUNCTION [data].[Cluster_SqlServer_Database_Encryption_Key_Sightings_Removable]
(
...
SELECT [data].[Cluster_SqlServer_Database_Encryption_Key_Sightings].[SightingDate], [data].[Cluster_SqlServer_Database_Encryption_Key_Sightings].[Id]
...
INNER JOIN [data].[Cluster_SqlServer_Database_Encryption_Key_Sightings] ON [data].[Cluster_SqlServer_Database_Encryption_Key_Sightings].[Id] = [data].[Cluster_SqlServer_Database_Encryption_Key_Keys].[Id]
