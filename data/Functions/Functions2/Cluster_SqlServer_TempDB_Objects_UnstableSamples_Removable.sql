CREATE FUNCTION [data].[Cluster_SqlServer_TempDB_Objects_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_TempDB_Objects_UnstableSamples] ON [data].[Cluster_SqlServer_TempDB_Objects_UnstableSamples].[Id] = [data].[Cluster_SqlServer_TempDB_Objects_Keys].[Id]
