CREATE FUNCTION [data].[Cluster_SqlServer_MirroringEndpoint_Sightings_Removable]
(
...
SELECT [data].[Cluster_SqlServer_MirroringEndpoint_Sightings].[SightingDate], [data].[Cluster_SqlServer_MirroringEndpoint_Sightings].[Id]
...
INNER JOIN [data].[Cluster_SqlServer_MirroringEndpoint_Sightings] ON [data].[Cluster_SqlServer_MirroringEndpoint_Sightings].[Id] = [data].[Cluster_SqlServer_MirroringEndpoint_Keys].[Id]
