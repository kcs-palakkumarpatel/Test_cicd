CREATE FUNCTION [data].[Cluster_SqlServer_Database_Encryption_StableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_Database_Encryption_StableSamples] ON [data].[Cluster_SqlServer_Database_Encryption_StableSamples].[Id] = [data].[Cluster_SqlServer_Database_Keys].[Id]
