CREATE FUNCTION [data].[Cluster_SqlServer_Database_TransactionVersionStore_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_Database_TransactionVersionStore_UnstableSamples] ON [data].[Cluster_SqlServer_Database_TransactionVersionStore_UnstableSamples].[Id] = [data].[Cluster_SqlServer_Database_Keys].[Id]
