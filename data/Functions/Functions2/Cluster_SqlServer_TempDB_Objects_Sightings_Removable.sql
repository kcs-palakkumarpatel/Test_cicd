CREATE FUNCTION [data].[Cluster_SqlServer_TempDB_Objects_Sightings_Removable]
(
...
SELECT [data].[Cluster_SqlServer_TempDB_Objects_Sightings].[SightingDate], [data].[Cluster_SqlServer_TempDB_Objects_Sightings].[Id]
...
INNER JOIN [data].[Cluster_SqlServer_TempDB_Objects_Sightings] ON [data].[Cluster_SqlServer_TempDB_Objects_Sightings].[Id] = [data].[Cluster_SqlServer_TempDB_Objects_Keys].[Id]
