CREATE FUNCTION [data].[Cluster_ClusterSharedVolumes_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_ClusterSharedVolumes_UnstableSamples] ON [data].[Cluster_ClusterSharedVolumes_UnstableSamples].[Id] = [data].[Cluster_ClusterSharedVolumes_Keys].[Id]
