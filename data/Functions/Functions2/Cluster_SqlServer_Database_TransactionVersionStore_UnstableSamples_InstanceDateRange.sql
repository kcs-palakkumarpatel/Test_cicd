CREATE FUNCTION [data].[Cluster_SqlServer_Database_TransactionVersionStore_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_ReservedBytes] AS [Cluster_SqlServer_Database_TransactionVersionStore_ReservedBytes]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_ReservedBytes]
    FROM [data].[Cluster_SqlServer_Database_TransactionVersionStore_UnstableSamples]
