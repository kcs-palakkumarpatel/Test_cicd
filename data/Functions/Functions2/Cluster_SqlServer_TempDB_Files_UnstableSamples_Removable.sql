CREATE FUNCTION [data].[Cluster_SqlServer_TempDB_Files_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_TempDB_Files_UnstableSamples] ON [data].[Cluster_SqlServer_TempDB_Files_UnstableSamples].[Id] = [data].[Cluster_SqlServer_TempDB_Files_Keys].[Id]
