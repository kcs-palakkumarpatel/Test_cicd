CREATE FUNCTION [data].[Cluster_SqlServer_Database_File_Performance_UnstableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_Database_File_Performance_UnstableSamples] ON [data].[Cluster_SqlServer_Database_File_Performance_UnstableSamples].[Id] = [data].[Cluster_SqlServer_Database_File_Keys].[Id]
