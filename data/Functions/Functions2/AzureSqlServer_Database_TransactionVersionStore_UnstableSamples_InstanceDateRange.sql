CREATE FUNCTION [data].[AzureSqlServer_Database_TransactionVersionStore_UnstableSamples_InstanceDateRange]
(
...
, [Leaf].[_ReservedBytes] AS [AzureSqlServer_Database_TransactionVersionStore_ReservedBytes]
FROM
 [SightedInstances]
INNER JOIN
(
...
(
    ...
    [CollectionDate]
    , [_ReservedBytes]
    FROM [data].[AzureSqlServer_Database_TransactionVersionStore_UnstableSamples]
