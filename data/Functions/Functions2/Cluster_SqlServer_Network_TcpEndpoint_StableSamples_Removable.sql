CREATE FUNCTION [data].[Cluster_SqlServer_Network_TcpEndpoint_StableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_Network_TcpEndpoint_StableSamples] ON [data].[Cluster_SqlServer_Network_TcpEndpoint_StableSamples].[Id] = [data].[Cluster_SqlServer_Network_TcpEndpoint_Keys].[Id]
