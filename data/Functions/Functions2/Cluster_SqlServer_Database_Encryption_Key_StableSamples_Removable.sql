CREATE FUNCTION [data].[Cluster_SqlServer_Database_Encryption_Key_StableSamples_Removable]
(
...
INNER JOIN [data].[Cluster_SqlServer_Database_Encryption_Key_StableSamples] ON [data].[Cluster_SqlServer_Database_Encryption_Key_StableSamples].[Id] = [data].[Cluster_SqlServer_Database_Encryption_Key_Keys].[Id]
