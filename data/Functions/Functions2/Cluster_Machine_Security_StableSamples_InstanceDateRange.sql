CREATE FUNCTION [data].[Cluster_Machine_Security_StableSamples_InstanceDateRange]
(
...
, [Leaf].[_FipsEnabled] AS [Cluster_Machine_Security_FipsEnabled]
FROM
 [SightedInstances]
LEFT OUTER JOIN
(
    SELECT [Id], MAX([CollectionDate]) as [GreatestMinDate]
    FROM [data].[Cluster_Machine_Security_StableSamples]
...
INNER JOIN
 [data].[Cluster_Machine_Security_StableSamples] [Leaf]
