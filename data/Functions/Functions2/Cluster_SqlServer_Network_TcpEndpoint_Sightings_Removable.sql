CREATE FUNCTION [data].[Cluster_SqlServer_Network_TcpEndpoint_Sightings_Removable]
(
...
SELECT [data].[Cluster_SqlServer_Network_TcpEndpoint_Sightings].[SightingDate], [data].[Cluster_SqlServer_Network_TcpEndpoint_Sightings].[Id]
...
INNER JOIN [data].[Cluster_SqlServer_Network_TcpEndpoint_Sightings] ON [data].[Cluster_SqlServer_Network_TcpEndpoint_Sightings].[Id] = [data].[Cluster_SqlServer_Network_TcpEndpoint_Keys].[Id]
