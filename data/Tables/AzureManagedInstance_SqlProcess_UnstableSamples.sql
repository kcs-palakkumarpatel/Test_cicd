CREATE TABLE [data].[AzureManagedInstance_SqlProcess_UnstableSamples] (
    [Id]                               BIGINT          NOT NULL,
    ...
    CONSTRAINT [AzureManagedInstance_SqlProcess_UnstableSamples_Id_CollectionDate] PRIMARY KEY CLUSTERED ([Id] ASC, [CollectionDate] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [AzureManagedInstance_SqlProcess_UnstableSamples_AzureManagedInstance_SqlProcess_Keys] FOREIGN KEY ([Id]) REFERENCES [data].[AzureManagedInstance_SqlProcess_Keys] ([Id]) ON DELETE CASCADE
);
