CREATE TABLE [data].[AzureSqlServer_Database_SqlProcess_UnstableSamples] (
    ...
    CONSTRAINT [AzureSqlServer_Database_SqlProcess_UnstableSamples_Id_CollectionDate] PRIMARY KEY CLUSTERED ([Id] ASC, [CollectionDate] ASC) WITH (DATA_COMPRESSION = PAGE),
    CONSTRAINT [AzureSqlServer_Database_SqlProcess_UnstableSamples_AzureSqlServer_Database_SqlProcess_Keys] FOREIGN KEY ([Id]) REFERENCES [data].[AzureSqlServer_Database_SqlProcess_Keys] ([Id]) ON DELETE CASCADE
);
